...
hhfe = HueHistogramFeatureExtractor(10) #look for hue
# # look at the basic shape
extractors = [hhfe] # put these all together
svm2 = SVMClassifier(extractors) # try an svm, default is an RBF kernel function
#trainPaths = ['/home/ctorney/Dropbox/projects/wildebeest/images/train/yes/','/home/ctorney/Dropbox/projects/wildebeest/images/train/no/']
trainPaths = ['./yes/','./no/']
...
classes = ['yes','no']
# # # train the data
print svm2.train(trainPaths,classes,verbose=False)
print "----------------------------------------"
